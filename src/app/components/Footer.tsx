  ...
  return (
    <footer className="relative overflow-hidden bg-slate-950 py-12 text-slate-100">
      ...
      <div className="container relative mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-4">
        <div className="space-y-4 md:col-span-2">
          ...
          <p className="max-w-xl text-sm leading-6 text-slate-300">
            Cổng thông tin điện tử phục vụ công tác công khai thông tin, tiếp nhận hồ sơ hành chính và kết nối phản ánh kiến nghị từ người dân.
          </p>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-sm text-slate-300">
            <li className="flex items-center gap-2"><MapPin size={16} /> UBND Phường Sa Đéc, TP Sa Đéc</li>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com" target="_blank" rel="noreferrer" className="rounded-full bg-white/10 p-2 transition-colors hover:bg-blue-600 hover:text-white">
              <Facebook size={20} />
            </a>
            <a href="https://www.instagram.com" target="_blank" rel="noreferrer" className="rounded-full bg-white/10 p-2 transition-colors hover:bg-blue-600 hover:text-white">
              <Instagram size={20} />
            </a>
          </div>
        </div>
      ...
      <div className="container relative mx-auto mt-8 border-t border-white/10 px-4 pt-8 text-center text-sm text-slate-400">
        © 2026 Cổng thông tin điện tử Phường Sa Đéc. Vận hành bởi UBND Phường Sa Đéc.
      </div>
    </footer>
  );
}

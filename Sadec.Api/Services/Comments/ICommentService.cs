...
public interface ICommentService
{
    ...
    Task<bool> GetAutoApproveEnabledAsync(CancellationToken cancellationToken = default);
    Task SetAutoApproveEnabledAsync(bool enabled, CancellationToken cancellationToken = default);
    ...
    Task<int> DeleteReviewedHistoryAsync(bool includePending = false, CancellationToken cancellationToken = default);
}

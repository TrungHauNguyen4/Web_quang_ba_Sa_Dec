...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TinTuc>(entity =>
        {
            ...
            entity.Property(x => x.DanhMuc).HasMaxLength(120);
            entity.HasIndex(x => x.DanhMuc);
        ...
        modelBuilder.Entity<MonAn>(entity =>
        {
            ...
            entity.Property(x => x.AnhDaiDienUrl).HasMaxLength(1000);
            entity.Property(x => x.AnhBoSungJson).HasMaxLength(8000);
            entity.Property(x => x.VideoUrl).HasMaxLength(1000);
        ...
        modelBuilder.Entity<HoSoDichVu>(entity =>
        {
            ...
            entity.Property(x => x.TepDinhKemJson).HasMaxLength(8000);
        ...
        modelBuilder.Entity<ThuTucDichVu>(entity =>
        {
            ...
            entity.Property(x => x.MoTa).HasMaxLength(2000);
            entity.Property(x => x.CauHinhBieuMauJson).HasMaxLength(8000);
        });
        ...
        modelBuilder.Entity<AuditLog>(entity =>
        {
            ...
            entity.Property(x => x.TargetType).HasMaxLength(120).IsRequired();
